...
**Key features**:
[Simulates IoT & Weather data ingestion (structured & semi-structured)
Batch ETL with Spark to MySQL and Hive for scalable storage
Streaming pipeline using Kafka + Spark Structured Streaming
Optional monitoring with Grafana & Prometheus
Docker-based setup for reproducibility and deployment]
